...
let paraString = resultado13 .toString()
...
const produto = 2.00
let comprada = 40
let resultado16 = comprada * produto
...
console.log(typeof resultado17 , resultado17)
//18.
...
let horas = 12
let pagoPorHora = 20
let pago = (horas * pagoPorHora)
console.log(pago >= 500)
//21.
...
const nome = "MateusPohlmannLauxen"
let quantidade22 = nome.length
console.log(quantidade22)
//23.
...
let a23 = 5
let b23 = 15
let resultado23 = a23 - b23
if(resultado23 < 0){
    console.log("O resultado é negativo")
}else{
    console.log("O resultado não é negativo")
}
